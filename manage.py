...
def drive(cfg, model_path=None, use_joystick=False, model_type=None, camera_type='single', meta=[] ):
    ...
    if cfg.DONKEY_GYM:
    ...
    elif cfg.DRIVE_TRAIN_TYPE == "SERVO_ESC_2":
        from donkeycar.parts.actuator import PCA9685, PWMSteering, PWMThrottle
        ...
        steering_s_controller = PCA9685(cfg.STEERING_S_CHANNEL, cfg.PCA9685_I2C_ADDR, busnum=cfg.PCA9685_I2C_BUSNUM)
        steering_s = PWMSteering(controller=steering_s_controller,
                                        left_pulse=cfg.STEERING_S_LEFT_PWM,
                                        right_pulse=cfg.STEERING_S_RIGHT_PWM)
