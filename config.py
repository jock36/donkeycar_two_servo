...
DRIVE_TRAIN_TYPE = "SERVO_ESC_2" # SERVO_ESC|DC_STEER_THROTTLE|DC_TWO_WHEEL|SERVO_HBRIDGE_PWM

#STEERING
STEERING_CHANNEL = 9            #channel on the 9685 pwm board 0-15
STEERING_LEFT_PWM = 240         #pwm value for full left steering
STEERING_RIGHT_PWM = 560        #pwm value for full right steering

#STEERING_s
STEERING_S_CHANNEL = 10            #channel on the 9685 pwm board 0-15
STEERING_S_LEFT_PWM = 560         #pwm value for full left steering
STEERING_S_RIGHT_PWM = 300        #pwm value for full right steering

#THROTTLE
THROTTLE_CHANNEL = 8            #channel on the 9685 pwm board 0-15
...
TRAIN_TEST_SPLIT = 0.7          #what percent of records to use for training. the remaining used for validation.
